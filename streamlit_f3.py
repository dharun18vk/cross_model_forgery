...
class LipSyncAnalyzer:
            ...
            with results_container:
                ...
                while True:
                    ...
                    if len(buffer) == SEQ_LEN:
                        ...
                        # Make prediction
                        prediction = None
                        # In the analyze_video method, update the prediction section:
                        if frame_idx < SEQ_LEN * 3:
                            status = "WARMING UP"
                            prediction = "WARMUP"
                        else:
                            # You can keep the detailed criteria for frame-level predictions
                        ...
                        # Add small delay for visualization (optional)
                        # time.sleep(0.01)
    ...
    def _display_final_results(self, results):
        ...
        if results['total_decisions'] > 0:
            ...
            # ✅ CHANGED: Final prediction based on 50% threshold
            ...
            elif fake_ratio > 0.50:  # Changed from >= 0.40 to > 0.50
                st.error(f"❌ **FAKE VIDEO** - {fake_ratio*100:.1f}% of frames show lip sync issues (over 50%)")
                final_verdict = "FAKE"
                verdict_color = "error"
            elif fake_ratio >= 0.30:  # Adjusted other thresholds
